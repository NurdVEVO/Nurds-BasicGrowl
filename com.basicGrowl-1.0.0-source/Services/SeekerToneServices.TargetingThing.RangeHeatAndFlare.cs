    ...
    internal sealed partial class SeekerToneServices
    {
            ...
            out float shotRangeMaxMeters)
        {
            ...
            try
            {
                ...
                {
                    // Fallback to static max-range capability if dynamic range is unavailable.
                    max = _activeMissileForRange.GetMaxRange();
                }
        ...
        {
            if (unit == null || NetworkHQProperty == null) return null;

            try
            {
                return NetworkHQProperty.GetValue(unit, null) as FactionHQ;
            }
            catch
            {
                return null;
                ...
                try
                {
                    ...
                    if (list != null && list.Count > 0)
                    {
                        ...
                        for (int i = 0; i < list.Count; i++)
                        {
                            ...
                            if (!s.flare || s.transform == null) continue;
